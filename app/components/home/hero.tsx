        ...
        <div className="border-t bg-white p-4 shadow-lg">
          <form onSubmit={handleSubmit} className="flex space-x-4">
            <input
              ...
              className="flex-1 px-4 py-2 rounded-lg border focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50"
              disabled={isLoading}
            />
            <button
              type="submit"
...
//     <div className="flex min-h-screen bg-blue-200">
//       {/* Sidebar */}
//       <div className="hidden md:flex w-64 bg-gray-900 text-white flex-col fixed top-0 left-0 transition-transform -translate-x-full sm:translate-x-0">
//         <div className="p-4 border-b border-gray-700">
//           <h1 className="text-xl font-bold">My Portfolio</h1>
//         </div>
//         <nav className="flex-1 overflow-y-auto p-4 space-y-2">
...
//               <Linkedin className="w-5 h-5 cursor-pointer hover:text-blue-400 transition-colors" />
//             </a>
//             <a href="mailto:ewherheakpesiri@gmail.com">
//               <Mail className="w-5 h-5 cursor-pointer hover:text-blue-400 transition-colors" />
//             </a>
//           </div>
//         </div>
